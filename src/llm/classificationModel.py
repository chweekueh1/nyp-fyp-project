"""
Classification Model module for the NYP FYP CNC Chatbot.

Handles text classification and RAG workflows. Loads API keys and configuration from environment variables using dotenv.
"""
