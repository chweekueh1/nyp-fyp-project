...
def format_markdown(text: str) -> str:
    ...
    4. Newline normalization
    5. HTML entity sanitization for safety
    6. Arrow character escaping for proper rendering (excluding Mermaid diagrams)
    ...
    # Step 3: Format other code blocks with proper spacing
    formatted_text = _format_code_blocks(formatted_text)

    # Step 4: Escape arrow characters in non-code content (excluding Mermaid blocks)
