...
def test_fast_keyword_extraction():
    ...
    try:
        ...
        print(f"  ✅ Fast keyword extraction: PASSED")
...
def test_optimized_text_extraction():
    ...
    try:
        from llm.dataProcessing import ExtractText, FastTextExtraction
        ...
        try:
            ...
            print(f"  🔧 Method: {result[0].metadata.get('extraction_method', 'unknown')}")
            print(f"  ✅ Optimized text extraction: PASSED")
...
def test_optimized_chunking():
    ...
    try:
        ...
        print(f"  ✅ Optimized chunking: PASSED")
...
def test_memory_conscious_batching():
    ...
    try:
        ...
        print(f"  ✅ Memory-conscious batching: PASSED")
...
def test_complete_pipeline_performance():
    ...
    try:
        ...
        try:
            ...
            from llm.dataProcessing import ExtractText, FastKeyBERTMetadataTagger, optimizedRecursiveChunker
