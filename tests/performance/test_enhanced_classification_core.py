...
def test_enhanced_content_extraction_core():
    ...
    try:
        from gradio_modules.enhanced_content_extraction import (
            ...
            extract_text_file_content, extract_with_pandoc, extract_with_tesseract
        )
        ...
        try:
            ...
            print(f"  ✅ Enhanced content extraction core: PASSED")
...
def test_classification_formatter_core():
    ...
    try:
        from gradio_modules.classification_formatter import (
            format_classification_response, format_security_classification,
            format_sensitivity_level, format_file_information, format_reasoning
        )
        ...
        print(f"  ✅ Security classification formatting works")
        ...
        print(f"  ✅ Sensitivity level formatting works")
        ...
        print(f"  ✅ Reasoning formatting works")
        ...
        print(f"  ✅ Complete response formatting works")
        print(f"  ✅ Classification formatter core: PASSED")
    ...
    try:
        ...
        try:
            for file_ext, expected_method_type in test_cases:
                ...
                print(f"  📄 {file_ext}: method={result['method']}, expected_type={expected_method_type}")
                
                # Verify method selection logic
                if expected_method_type == 'text_file' and result['method'] == 'text_file':
            ...
            print(f"  ✅ Extraction method selection logic works")
            print(f"  ✅ Extraction method selection: PASSED")
...
def test_performance_improvements():
    ...
    try:
        ...
        try:
            ...
            assert extraction_time < 1.0, f"Extraction took too long: {extraction_time:.3f}s"
            
            print(f"  ✅ Performance is acceptable")
            print(f"  ✅ Performance improvements: PASSED")
